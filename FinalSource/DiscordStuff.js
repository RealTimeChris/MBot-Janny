...
function doWeHaveAdminPermission(message, discordUser) {
    return __awaiter(this, void 0, void 0, function () {
        var currentChannelPermissions, permissionStrings, areTheyAnAdmin, areTheyACommander, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
...
function recurseThroughServerRecords(dataBase, liveGuildArray, keyNames, y) {
    if (y === void 0) { y = 0; }
    return __awaiter(this, void 0, void 0, function () {
        var yNew, fileString, fileObject, guildMembersCollection, membersArray, z, areTheyFoundInFile, w, userRecord, serverRecordKey, error_4, serverRecord, guildMembersCollection, membersArray, z, userRecord, serverRecordKey;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 9]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        error_23 = _a.sent();
                        if (!(error_23.message === 'Unknown Channel')) return [3 /*break*/, 5];
                    ...
                    case 22:
                        ...
                        if (!!arrayOfMessageArrays[y][z].pinned) return [3 /*break*/, 24];
                    ...
                    case 27:
                        ...
                        _a.label = 28;
                    case 28:
                        if (!(x !== 0)) return [3 /*break*/, 33];
                        arrayOfMessages = void 0;
                        if (!(y === 0)) return [3 /*break*/, 30];
                        return [4 /*yield*/, currentChannel.messages.fetch({ limit: 100 })];
                    case 29:
                        arrayOfMessages = (_a.sent()).array();
                        return [3 /*break*/, 32];
                    case 30: return [4 /*yield*/, currentChannel.messages
                            .fetch({ limit: 100, })];
                    case 31:
                        arrayOfMessages = (_a.sent()).array();
                        _a.label = 32;
                    ...
                    case 35:
                        ...
                        if (!!arrayOfMessageArrays[w][z].pinned) return [3 /*break*/, 37];

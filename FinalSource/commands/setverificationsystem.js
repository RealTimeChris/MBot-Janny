            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 14:
                        ...
                        if (!(guildData.verificationSystem.channelID === null)) return [3 /*break*/, 15];
                        msgString = '------\n__The verification system is currently disabled.__\n------\n';
                        return [3 /*break*/, 17];
                    case 15: return [4 /*yield*/, message.fetch(guildData.verificationSystem.messageID)];
                    case 16:
                        newMessage = _a.sent();
                    ...
                    case 34:
                        _a.sent();
                        return [2 /*return*/, this.name];
                    case 35: return [2 /*return*/, this.name];
                    case 36:
                        error_1 = _a.sent();

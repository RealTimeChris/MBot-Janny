        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 13:
                        guildData = {};
                        currentGuild = new Discord.Guild(message.client, guildData);
                        currentGuild = message.client.guilds.resolve(message.guild.id);
                        currentTextChannelData = {};
                        currentTextChannel = new Discord.TextChannel(currentGuild, currentTextChannelData);
                    ...
                    case 40:
                        _a.sent();
                        return [2 /*return*/, this.name];
                    case 41: return [2 /*return*/, this.name];
                    case 42:
                        error_3 = _a.sent();

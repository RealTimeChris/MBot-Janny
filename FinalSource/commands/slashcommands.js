...
function execute(commandData, discordUser) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const interaction = new slash_commands_1.default({ applicationId: discordUser.userData.userID,
                publicKey: discordUser.userData.publicKey,
                authToken: discordUser.userData.botToken });
            const commands = yield interaction.getApplicationCommands();
            ...
            /*
                    ...
                    */
            const globalCommands = yield interaction.getApplicationCommands();
            ...
            for (let x = 0; x < msgEmbeds.length; x += 1) {
                ...
                yield HelperFunctions_1.default.sendMessageWithCorrectChannel(commandData, msgEmbeds[x]);
            }

            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        commandFiles_1 = fs.readdirSync('commands').filter(function (file) { return file.endsWith('.js'); });
                        if (!(args[0] === undefined)) return [3 /*break*/, 8];
                        commandNames_1 = [String('')];
                        commandFiles_1.map(function (file) {
                            var command = require("./" + file);
                            commandNames_1[file] = command.name;
                        ...
                        commandFiles_1.map(function (file) {
                            msgString_1 += commandNames_1[file];
                            currentIndex_1 += 1;
                            if (currentIndex_1 < commandFiles_1.length) {
                                msgString_1 += ', ';
                            }
                            return commandNames_1;
                        });
